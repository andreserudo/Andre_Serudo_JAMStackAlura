    ...
    projects: [
      {
        ...
        descricao: 'A reunião de todos os desafios que fiz para o Front End Mentor.',
      ...
      },
      {
        titulo: 'eColeta',
        descricao:
        `Como uma página de uma start-up de doações e distribuição pareceria-se?
        Esse foi um projeto feito durante o bootcamp da Rocketseat. Stacks: Typescript, Reactjs, Nodejs.`,
